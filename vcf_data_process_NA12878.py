...
insert_result_data.insert(4,'END',0)
insert_result_data.insert(5,'SEND',0)
insert_result_data.insert(6,'EEND',0)
...
for index, row in insert_result_data.iterrows():
    ...
    if pos == -1:
        ...
        s = s.split(";")[0]
        s = int(s)
        insert_result_data.loc[index, ["END"]] = s
    else:
        pos = pos + 6 # "SVLEN="
        s = s[pos:]
        s = s.split(";")[0]
        ...
        insert_result_data.loc[index, ["END"]] = end
    ...
    if pos != -1:
        ...
        insert_result_data.loc[index, ["SEND"]] = start
        insert_result_data.loc[index, ["EEND"]] = end
